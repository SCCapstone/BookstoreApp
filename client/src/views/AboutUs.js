  ...
  return (
    <div className="aboutus">
      <div className="page-title-container">
        <h1 className="page-title-text">About Us</h1>
      </div>
      <p>
        ...
        Columbia and central South Carolina as well as people from all over the
        rest of the US and many other parts of the world with everything from
        paperbacks to world class collectible books and maps. This website has
        been refurbished so that both employees and customers can use this site.
      </p>
