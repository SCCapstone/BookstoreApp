            ...
            <div class="w-full py-16 gap-2 ">
              ...
              <form class="justify-center">
                <div class="mb-6">
                  <input
                    type="text"
                    class="form-control placeholder-black block w-full px-4 py-2 text-xl font-normal text-black bg-camel border border-solid rounded"
                ...
                <div class="mb-6">
                  <input
                    type="password"
                    class="form-control placeholder-black block w-full px-4 py-2 text-xl font-normal text-black bg-camel border border-solid border-black rounded"
                    id="exampleFormControlInput2"
