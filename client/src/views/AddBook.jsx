                ...
                <Grid class="flex xl:justify-center lg:justify-between justify-center items-center grid grid-cols-3 h-full g-6">
                    <form>
                        ...
                        <div className="flex pb-2 pt-2">
                            <Chip 
                                avatar={
                                    <Avatar onClick={() => this.handleChange({ target: { name: "stock", value: this.state.stock - 1 }})}>
                                    <Remove />
                                    </Avatar>
                                }
                                label={
                                    <p className="px-2 text-lg ">{this.state.stock}</p>
                                }
                                clickable
                                onDelete={() => this.handleChange({ target: { name: "stock", value: this.state.stock + 1 }})}
                                deleteIcon={<Add />}
                            />
                            <button className="pl-4" onClick={() => this.handleChange({ target: { name: "stock", value: 0 }})}>
                                {" "}
                                Clear{" "}
                            </button>
                        </div>
