...
const validate = (data) => {
    const schema = Joi.object({
        firstName: Joi.string().required().label("firstName").error(new Error("firstName is invalid")),
        lastName: Joi.string().required().label("lastName").error(new Error("lastName is invalid")),
